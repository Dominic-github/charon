      ...
      <ScreenHeader v-if="podcast" :layout="headerLayout">
        ...
        <template #controls>
          <div class="flex gap-2 flex-wrap">
            ...
            <BtnGroup uppercase>
              <Btn v-if="episodes" v-charon-tooltip="'Refresh'" success @click.prevent="refresh">
                <Icon :icon="faRotateRight" fixed-width />
              </Btn>
              <Btn v-charon-tooltip="'Unsubscribe'" danger uppercase @click.prevent="unsubscribe">
            ...
            <Btn v-charon-tooltip="'Visit podcast website'" tag="a" gray :href="podcast.link" target="_blank">
