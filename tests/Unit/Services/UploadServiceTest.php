...
class UploadServiceTest extends TestCase
{
    ...
    public function handleUpload(): void
    {
        ...
        $scanInfo = ScanInformation::fromGetId3Info([], '/var/media/charon/some-file.mp3');
        $file = '/var/media/charon/some-file.mp3';
        $song = Song::factory()->create();
        $uploader = create_user();

        $reference = UploadReference::make(
            location: '/var/media/charon/some-file.mp3',
            localPath: '/var/media/charon/some-file.mp3',
        );
        ...
        $this->scanner->expects('scan')
            ->with('/var/media/charon/some-file.mp3')
            ->andReturn($scanInfo);
    ...
    public function uploadUpdatesSongPathAndStorage(): void
    {
        ...
        $reference = UploadReference::make(
            location: 's3://charon/some-file.mp3',
        ...
        self::assertSame($song, $result);
        self::assertSame('s3://charon/some-file.mp3', $song->path);
