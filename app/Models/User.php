...
class User extends Authenticatable implements AuditableContract
{
    ...
    private const FIRST_ADMIN_NAME = 'Admin';
    public const FIRST_ADMIN_EMAIL = 'admin@charon.dev';
    public const FIRST_ADMIN_PASSWORD = 'admin';
    ...
    {
        return Attribute::get(fn(): bool => true && $this->sso_provider)->shouldCache();
    }
