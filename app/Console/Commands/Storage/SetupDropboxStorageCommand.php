...
{
    protected $signature = 'charon:storage:dropbox';
    protected $description = 'Set up Dropbox as the storage driver for Charon';
    ...
    public function handle(): int
    {
        ...
        $this->components->info('Setting up Dropbox as the storage driver for Charon.');
        ...
        $this->comment('Please visit the following link to authorize Charon to access your Dropbox account:');
        $this->info($tmpUrl);
        $this->comment('The link will expire in 15 minutes.');
        $this->comment('After you have authorized Charon, enter the access code below.');
