...
{
    protected $signature = 'charon:storage:local';
    protected $description = 'Set up the local storage for Charon';
    ...
    {
        $this->components->info('Setting up local storage for Charon.');
